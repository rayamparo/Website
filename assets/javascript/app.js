...
$("#visitQuizRepo").on("click", function (){
    window.location.href = "https://github.com/adriennefr/project2";
})
...
function removeHiddenNumber(){
    $('#numberLabel').removeClass('hidden');
    if($('#number').val() === "") {
        $('#numberLabel').addClass('hidden');
    }
}
...
// Send Button receiving all input values
...
// Header Background
// $('.water').css('width', $('.back').width()*2);
// $('.water').css('height', $('.back').width()*2);
